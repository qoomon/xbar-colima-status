...
COLIMA_STATUS_FILE="${TMPDIR:-/tmp}/xbar_colima_status"
...
then
    ...
    then
    	...
    	echo '---'
    	echo "Stop Colima | shell=$0 param1=stop terminal=false"
    else
        echo "| templateImage=$COLIMA_STOPPED_ICON"
    	echo '---'
    	echo "Start Colima | shell=$0 param1=start terminal=false"
    fi
